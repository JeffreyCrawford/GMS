...
const columnData = [
  ...
  { id: 'environmentalImpact', numeric: false, disablePadding: false, label: 'Environmental Impact' },
  { id: 'totalImpacted', numeric: false, disablePadding: true, label: 'Total Impacted' },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell >{n.environmentalImpact}</TableCell>
                      <TableCell >{n.totalImpacted}</TableCell>
